import type { _StripDot, Integrity, IntegrityDigest, IntegrityKeys } from './integrity'
 ...
 * Key is the union of possible keys, and value the union of possible field values to hash.
